namespace Actividad1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("El promedio del curso es: " + average);
            
            Console.WriteLine("Estos son los estudiantes con notas mas bajas que el promedio");
            foreach (var grade in grades)
            {
                if (grade.Value < average)
                {
